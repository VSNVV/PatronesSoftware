...
public class Servidor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelBuscar.setBackground(new java.awt.Color(153, 153, 153));
        panelBuscar.setForeground(new java.awt.Color(153, 153, 153));
        panelBuscar.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        panelBuscar.add(tfIdVehiculo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 150, 30));

        labelIdVehiculo.setText("Id del vehiculo");
        panelBuscar.add(labelIdVehiculo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, -1));

        botonBuscarVehiculo.setBackground(new java.awt.Color(0, 0, 0));
        botonBuscarVehiculo.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(JPanelPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 1230, 760));
